...
class EditRunnerRequests extends StatefulWidget {
  final RunnerModel data;
  const EditRunnerRequests({Key? key, required this.data}) : super(key: key);

  @override
  State<EditRunnerRequests> createState() => _EditRunnerRequestsState();
}

class _EditRunnerRequestsState extends State<EditRunnerRequests> {
  ...
  void initState() {
    ...
    //  branchController.text = branchNameById[widget.data.branchId].toString();
